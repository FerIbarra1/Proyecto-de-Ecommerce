        ...
        <Col md={8}>
            ...
            <Card.Body>
              ...
              {order.isDelivered ? (
                <MessageBox variant="success">
                  Entregado el {order.deliveredAt.substring(0, 10)} a las {order.deliveredAt.substring(11, 16)}
                </MessageBox>
              ) : (
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              {order.isPaid ? (
                <MessageBox variant="success">
                  Pagado el {order.paidAt.substring(0, 10)} a las {order.paidAt.substring(11, 16)}
                </MessageBox>
              ) : (
